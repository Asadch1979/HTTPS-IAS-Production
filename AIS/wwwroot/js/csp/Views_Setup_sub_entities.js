    ...
    function publishSubEntityChanges() {
        ...
        if (g_entityId == 0)
            var row = "<tr id=\"div_" + g_entityId + " \"><td><p class=\"fw - normal mb - 1\">" + divName + "</p></td><td><p class=\"fw - normal mb - 1\">" + deptName + "</p></td><td><p class=\"fw - normal mb - 1\">" + entityName + "</p></td><td><span class=\"badge " + badge + " rounded - pill d - inline\">" + status + "</span></td><td><button type=\"button\" class=\"btn btn - link text - danger btn - sm btn - rounded\" data-onclick=\"setupSubEntity('" + divCode + "', '" + deptCode + "', '" + entityName + "', '" + status + "', '" + g_entityId + "'); \" > Edit</button></td ></tr >";
        else
            $('#div_' + g_entityId).html("<td><p class=\"fw - normal mb - 1\">" + divName + "</p></td><td><p class=\"fw - normal mb - 1\">" + deptName + "</p></td><td><p class=\"fw - normal mb - 1\">" + entityName + "</p></td><td><span class=\"badge " + badge + " rounded - pill d - inline\">" + status + "</span></td><td><button type=\"button\" class=\"btn btn - link text - danger btn - sm btn - rounded\" data-onclick=\"setupSubEntity('" + divCode + "', '" + deptCode + "', '" + entityName + "', '" + status + "','" + g_entityId + "'); \" > Edit</button></td >");
