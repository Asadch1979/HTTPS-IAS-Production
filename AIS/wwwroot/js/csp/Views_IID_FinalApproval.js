    $(function(){
        var pageRoot = document.getElementById('iidFinalApprovalRoot');
        ...
        function loadPageDataByComplaintId(selectedComplaintId){
            ...
            $.ajax({
                ...
                success: function(resp){
                    ...
                    $('#approvalForm [name="ReportId"]').val(reportId);
                    var links = [];
        ...
        $('#approvalForm').on('submit', function(e){
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    showIidAlert('Action saved', 'success');
                    location.reload();
                },
                error: function(){
                    showIidAlert('Failed to submit approval.', 'danger');
                }
            });
        });
        ...
        loadComplaintDropdown(pageId)
            .done(function(resp){
                ...
                $dd.off('change.iidFinalApproval').on('change.iidFinalApproval', function(){
                    var id = $(this).val();
