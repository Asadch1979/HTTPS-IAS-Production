                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $.each(data, function (i, v) {
                                $('#manageObsPanel tbody').append('<tr><td class="text-center">' + (i + 1) + '</td><td class="text-center">' + v.auditee + '</td><td class="text-center">' + v.audiT_PERIOD + '</td><td>' + v.parA_NO + '</td><td>' + v.annex + '</td><td>' + v.obS_RISK + '</td><td>' + v.obS_GIST + '</td><td>' + v.updateD_BY + '</td><td>' + v.updateD_ON + '</td><td class="text-center"><a data-click="event.preventDefault();ObservationViewerPanel(\'' + i + '\')" href="#" class="text-hover">View Para Details</a></td></tr>');
                        });
                ...
                success: function (data) {
                    ...
                    $.each(data, function (i, v) {
                        ...
                        $('#p_listofRespPersons tbody').append(
                            ...
                            '<td>' + act + '</td>' +
                            '<td>' + v.remarks + '</td>' +
                            '<td class="text-center"><a href="#" data-click="event.preventDefault();updateRespRow(this);">Update</a></td>' +
                            '<td class="text-center"><a href="#" class="text-danger" data-click="event.preventDefault();deleteRespRow(this);">Delete</a></td>' +
                            '</tr>'
                        );
                        sr_c++;
                    });
