    ...
    try {
        ...
        (function () {
            ...
            function createActionsCell(item) {
                ...
                return '<td class="text-center text-nowrap"><button class="btn btn-sm btn-primary" data-response-id="' + encodedId + '" data-click="editResponse(this.dataset.responseId)">Edit</button></td>';
            }
