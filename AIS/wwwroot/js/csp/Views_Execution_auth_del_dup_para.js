            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (i, v) {
                        $('#manageObsPanel tbody').append('<tr><td class="text-center">' + ++i + '</td><td class="text-center">' + v.entityName + '</td><td class="text-center">' + v.auditPeriod + '</td><td>' + v.paraNo + '</td><td>' + v.annex + '</td><td>' + v.risk + '</td><td>' + v.paraGist + '</td><td>' + v.remarks + '</td><td class="text-center"><a data-click="event.preventDefault();rejectDeleteDuplicateRequest(\'' + v.dId + '\')" href="#" class="text-hover">Reject</a></td><td class="text-center"><a data-click="event.preventDefault();authorizeDeleteDuplicateRequest(\'' + v.dId + '\')" href="#" class="text-hover">Authorize</a></td></tr>');
                    });
