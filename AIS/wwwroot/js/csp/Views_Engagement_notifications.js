    ...
    $('#document').ready(function () {
        ...
        $.each(g_checklist, function (i, v) {
            $('#checklistPanel tbody').append('<tr><td>' + v.srNo + '</td><td>' + v.observation + '</td><td><select class="checklistaction form-select form-control" data-onchange="showObservationArea($(this).val(),\'obs_' + v.srNo + '\');" aria-label="Default select example"><option value="0" id="0" selected>No</option><option value="1" id="1">Yes</option></select></td></tr>');
