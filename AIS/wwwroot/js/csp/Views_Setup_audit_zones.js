    ...
    function publishAuditZoneChanges() {
        ...
        if (g_divId == 0)
            var row = "<tr id=\"AZ_" + g_AZId + "\"><td class=\"AZ_code\"><p class=\"fw-normal mb-1\">" + code + "</p></td><td class=\"AZ_name\"><p class=\"fw-normal mb-1\">" + name + "</p></td ><td class=\"AZ_desc\"><p class=\"fw-normal mb-1\">" + desc + "</p></td><td class=\"AZ_status\"><span class=\"badge " + badge + " rounded-pill d-inline\">" + status + "</span></td><td class=\"AZ_action\"><button type=\"button\" class=\"btn btn-link text-danger btn-sm btn-rounded\" data-click=\"setupAuditZone('" + code + "','" + name + "','" + desc + "','" + status + "','" + g_AZId + "');\">Edit</button></td></tr>";
        else
