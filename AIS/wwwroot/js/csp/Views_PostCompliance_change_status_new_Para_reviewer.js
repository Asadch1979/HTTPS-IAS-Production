    ...
    function getLegacyPara() {
        ...
        $.ajax({
            url: g_asiBaseURL + "/ApiCalls/get_current_paras_for_status_change_request_review",
            type: "POST",
            data: {
    ...
    function Publishchange() {
        ...
        $.ajax({
            url: g_asiBaseURL + "/ApiCalls/Add_Old_Para_Change_status_Review",
            type: "POST",
            data: {
                'REFID': refp,
