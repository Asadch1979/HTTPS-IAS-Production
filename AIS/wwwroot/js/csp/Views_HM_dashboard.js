    ...
    function getPieChartData() {
        $.ajax({
            url: g_asiBaseURL + "/ApiCalls/get_pie_chart_data",
            type: "POST",
            data: {
    ...
    */
    ...
    var chartC = new CanvasJS.Chart("countrywide_volivolii", {
        ...
        data: [{
            ...
            showInLegend: true,
            dataPoints: [
                { x: new Date(2018, 12, 31), y: y[0] },
                { x: new Date(2019, 6, 30), y: y[1] },
                { x: new Date(2019, 12, 31), y: y[2] },
                { x: new Date(2020, 6, 30), y: y[3] },
        ...
        },
        {
            ...
            },
         {
                ...
                showInLegend: true,
                dataPoints: [
                    { x: new Date(2018, 12, 31), y: 100 },
                    { x: new Date(2019, 6, 30), y: 250 },
                    { x: new Date(2019, 12, 31), y: 310 },
                    { x: new Date(2020, 6, 30), y: 407 },
                    { x: new Date(2020, 12, 31), y: 389 },
                    { x: new Date(2021, 6, 30), y: 612 },
                    { x: new Date(2021, 12, 31), y: 488 },
                    { x: new Date(2022, 6, 30), y: 912 },
            ...
            },
            {
                ...
                showInLegend: true,
                dataPoints: [
                    { x: new Date(2018, 12, 31), y: 130 },
                    { x: new Date(2019, 6, 30), y: 170 },
                    { x: new Date(2019, 12, 31), y: 220 },
                    { x: new Date(2020, 6, 30), y: 315 },
                    { x: new Date(2020, 12, 31), y: 415 },
                    { x: new Date(2021, 6, 30), y: 715 },
                    { x: new Date(2021, 12, 31), y: 588 },
                    { x: new Date(2022, 6, 30), y: 488 },
