            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (i, v) {
                        ...
                        if (v.ind=="")
                            $('#manageObsPanel tbody').append(' <tr id="' + v.obS_ID + '"><td class="text-center">' + v.memo + '</td><td>' + v.drafT_PARA + '</td><td>' + v.finaL_PARA + '</td><td></td><td>' + v.title + '</td><td>' + v.status + '</td><td class="text-center"><a data-onclick="event.preventDefault();ObservationViewerPanel(' + v.obS_ID + ',' + v.statuS_ID + ', \'' + v.t_IND + '\')" href="#" class="text-hover">View Memo</a></td><td class="text-center"><a data-onclick="ObservationUpdatePanel(' + v.obS_ID + ')" href="#" class="text-hover">Edit Memo</a></td></tr>');
                        else
                            $('#manageObsPanel tbody').append(' <tr id="' + v.obS_ID + '"><td class="text-center">' + v.memo + '</td><td>' + v.drafT_PARA + '</td><td>' + v.finaL_PARA + '</td><td>' + v.e_NAME + '</td><td>' + v.title + '</td><td>' + v.status + '</td><td class="text-center"><a data-onclick="event.preventDefault();ObservationViewerPanel(' + v.obS_ID + ',' + v.statuS_ID + ', \'' + v.t_IND + '\')" href="#" class="text-hover">View Memo</a></td><td class="text-center"><a data-onclick="ObservationUpdatePanel(' + v.obS_ID + ')" href="#" class="text-hover">Edit Memo</a></td></tr>');
                    });
                    setTimeout(function () {
                        if (g_obsId != 0) {
