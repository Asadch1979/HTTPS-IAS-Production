        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each(data, function (i, v) {
                    ...
                    $('#manageObsPanel').append('<tr><td>' + ++i + '</td><td>' + v.v_NUMBER + '</td><td>' + v.a_NATURE + '</td><td>' + v.observation + '</td><td>' + v.parA_NO + '</td><td><a href="#" data-click="event.preventDefault();updateVoucherChecking(' + v.V_ID + ');"></a></td></tr>');
