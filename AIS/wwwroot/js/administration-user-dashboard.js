(function () {
    ...
    function updateBrowserState(stepKey) {
        var baseUrl = resolveAppUrl(stepHost.getAttribute('data-base-url') || '/AdministrationPanel/User_Dashboard');
    ...
    function loadStep(stepKey, stepNo) {
        ...
        var loadUrl = resolveAppUrl(stepHost.getAttribute('data-load-url') || '/AdministrationPanel/LoadUserDashboardStep');
