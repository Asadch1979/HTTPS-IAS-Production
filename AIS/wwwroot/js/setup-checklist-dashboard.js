(function () {
    ...
    function updateBrowserState(stepKey) {
        var baseUrl = stepHost.getAttribute('data-base-url') || '/Setup/Checklist_Dashboard';
    ...
    function loadStep(stepKey, stepNo) {
        ...
        var loadUrl = stepHost.getAttribute('data-load-url') || '/Setup/LoadChecklistDashboardStep';
