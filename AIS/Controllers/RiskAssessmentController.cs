...
namespace AIS.Controllers
    ...
    public class RiskAssessmentController : Controller
        ...
        public RiskAssessmentController(ILogger<RiskAssessmentController> logger, SessionHandler _sessionHandler, DBConnection _dbCon, TopMenus _tpMenu, IPermissionService permissionService)
            {
            _logger = logger;
