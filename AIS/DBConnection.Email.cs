...
namespace AIS.Controllers
    ...
    public partial class DBConnection
        ...
        public long LogEmailTriggerAttempt(string module, string triggerPoint, string referenceId, string toAddress, string ccAddress, string subject)
            ...
            cmd.CommandText = "PKG_EMAIL.LOG_TRIGGER_ATTEMPT";
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.BindByName = true;
            cmd.Parameters.Add("P_MODULE", OracleDbType.Varchar2).Value = DbValue(module, 100);
            cmd.Parameters.Add("P_TRIGGER_POINT", OracleDbType.Varchar2).Value = DbValue(triggerPoint, 200);
            cmd.Parameters.Add("P_REFERENCE_ID", OracleDbType.Varchar2).Value = DbValue(referenceId, 200);
            cmd.Parameters.Add("P_TO_ADDRESS", OracleDbType.Varchar2).Value = DbValue(toAddress, 2000);
            cmd.Parameters.Add("P_CC_ADDRESS", OracleDbType.Varchar2).Value = DbValue(ccAddress, 2000);
            cmd.Parameters.Add("P_EMAIL_SUBJECT", OracleDbType.Varchar2).Value = DbValue(subject, 1000);
        ...
        public void CompleteEmailTriggerAttempt(long logId, string status, string errorMessage, bool sent)
            ...
            using var con = DatabaseConnection(requireActiveSession: false);
            using var cmd = con.CreateCommand();
            cmd.CommandText = "PKG_EMAIL.COMPLETE_TRIGGER_ATTEMPT";
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.BindByName = true;
            cmd.Parameters.Add("P_LOG_ID", OracleDbType.Int64).Value = logId;
            cmd.Parameters.Add("P_STATUS", OracleDbType.Varchar2).Value = status;
            cmd.Parameters.Add("P_ERROR_MESSAGE", OracleDbType.Varchar2).Value = DbValue(errorMessage, 4000);
            cmd.Parameters.Add("P_IS_SENT", OracleDbType.Int32).Value = sent ? 1 : 0;
            cmd.ExecuteNonQuery();
            }
