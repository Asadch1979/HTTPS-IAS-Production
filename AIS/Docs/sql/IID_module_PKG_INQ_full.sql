/*
  IID Module
  Production-style executable script aligned with DBConnection.IID.cs

  Design notes:
  - Keeps ONE package only: PKG_INQ.
...
-------------------------------------------------------------------------------
-- Table Structures (simplified for demonstration; adjust as needed)
-------------------------------------------------------------------------------
T_AU_IID_INV_PLAN_ACT
T_AU_IID_LEAD_REVIEW
T_AU_IID_ANALYSIS
T_AU_IID_INQ_VIOLATION_STEP
T_AU_IID_EMAIL_QUEUE
T_AU_IID_REPORT
T_AU_IID_COMPLAINANT
T_AU_IID_COMPLAINT_HDR
T_AU_IID_INQ_DSA
T_AU_IID_INQ_VIOLATIONS
T_AU_IID_INV_PLAN
T_AU_IID_ASSESSMENT
T_AU_IID_CASE_STUDY
T_AU_IID_INQ_RECORD_SCRUTINIZED
T_AU_IID_INQ_ACCUSATIONS
T_AU_IID_INQ_FIND_RECOMM
T_AU_IID_STATUS_MST
T_AU_IID_COMPLAINT_IAID
T_AU_IID_FINAL_APPROVAL
T_AU_IID_INQ_EVIDENCE_STEP
T_AU_IID_INQ_EVIDENCE_FILES
T_AU_IID_INQ_PROCEEDINGS
T_AU_IID_INQ_ACCUSED_LIST
T_AU_IID_HEAD_REVIEW
T_AU_IID_HEAD_PLAN_APPROVAL
T_AU_IID_INQ_STATEMENTS


-------------------------------------------------------------------------------
Package and related objects creation (with safe drop blocks)
-------------------------------------------------------------------------------
