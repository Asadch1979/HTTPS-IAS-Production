/*
Step 06 - Replace PKG_INQ using the complete approved package specification/body.
*/
...
BEGIN
  ...
  IF V_VALID<>2 OR V_ERRORS>0 OR V_TYPE<>'VARCHAR2' THEN
    RAISE_APPLICATION_ERROR(
      -20823,
      'PKG_INQ validation failed: valid_objects='||V_VALID||
      ', errors='||V_ERRORS||', P_STATUS='||V_TYPE
    );
  END IF;
END;
/
