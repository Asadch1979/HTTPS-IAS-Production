/*
Step 13 - Validate and enable scheduler jobs.
...
BEGIN
  SELECT COUNT(*) INTO V_WEEKLY
   ...
   WHERE JOB_NAME='JOB_MGMT_AUDIT_WEEKLY_NOTIFY'
     AND ENABLED='FALSE'
     AND REPEAT_INTERVAL='FREQ=WEEKLY;BYDAY=MON;BYHOUR=07;BYMINUTE=00;BYSECOND=00';
  ...
  IF V_WEEKLY<>1 OR V_MAPPING<>1 OR V_HEALTH<>1 THEN
