/*
Step 08 - Replace PKG_AE using the complete approved package specification/body.
*/
...
BEGIN
  ...
  IF V_VALID<>2 OR V_ERRORS>0 THEN
    RAISE_APPLICATION_ERROR(
      -20825,
      'PKG_AE validation failed: valid_objects='||V_VALID||
      ', errors='||V_ERRORS
    );
  END IF;
END;
