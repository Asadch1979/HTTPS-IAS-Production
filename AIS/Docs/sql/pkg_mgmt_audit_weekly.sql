/*
  Commercial Audit Module
  Final executable script aligned with AIS\DBConnection.CAU.cs

  Notes:
  - Table names start with T_COM_ as requested.
  - Safe drop blocks are included for reruns.
  - Save procedures expose P_ID OUT because DBConnection.CAU.cs expects it.
  - Cursor parameters remain IO_CURSOR OUT T_CURSOR because DBConnection.CAU.cs uses IO_CURSOR.
  - ARPSE links to PDP through T_COM_AUDIT_ARPSE_PDP_MAP because DBConnection.CAU.cs exposes
    P_SAVE_ARPSE_PDP_MAP and P_GET_ARPSE_PDP_MAP.
*/

BEGIN
    FOR X IN (
        SELECT 'PACKAGE PKG_COMMERCIAL_AUDIT' AS DDL_TEXT FROM DUAL
        UNION ALL SELECT 'TABLE T_COM_AUDIT_ARPSE_PDP_MAP_HIST CASCADE CONSTRAINTS PURGE' FROM DUAL
        UNION ALL SELECT 'TABLE T_COM_AUDIT_ARPSE_PAC_HIST CASCADE CONSTRAINTS PURGE' FROM DUAL
        UNION ALL SELECT 'TABLE T_COM_AUDIT_ARPSE_DAC_HIST CASCADE CONSTRAINTS PURGE' FROM DUAL
        UNION ALL SELECT 'TABLE T_COM_AUDIT_ARPSE_HIST CASCADE CONSTRAINTS PURGE' FROM DUAL
        UNION ALL SELECT 'TABLE T_COM_AUDIT_PDP_OM_MAP_HIST CASCADE CONSTRAINTS PURGE' FROM DUAL
        UNION ALL SELECT 'TABLE T_COM_AUDIT_PDP_HIST CASCADE CONSTRAINTS PURGE' FROM DUAL
        UNION ALL SELECT 'TABLE T_COM_AUDIT_OM_HIST CASCADE CONSTRAINTS PURGE' FROM DUAL
        UNION ALL SELECT 'TABLE T_COM_AUDIT_ARPSE_PDP_MAP CASCADE CONSTRAINTS PURGE' FROM DUAL
        UNION ALL SELECT 'TABLE T_COM_AUDIT_ARPSE_PAC CASCADE CONSTRAINTS PURGE' FROM DUAL
        UNION ALL SELECT 'TABLE T_COM_AUDIT_ARPSE_DAC CASCADE CONSTRAINTS PURGE' FROM DUAL
        UNION ALL SELECT 'TABLE T_COM_AUDIT_ARPSE CASCADE CONSTRAINTS PURGE' FROM DUAL
        UNION ALL SELECT 'TABLE T_COM_AUDIT_PDP_OM_MAP CASCADE CONSTRAINTS PURGE' FROM DUAL
        UNION ALL SELECT 'TABLE T_COM_AUDIT_PDP CASCADE CONSTRAINTS PURGE' FROM DUAL
        UNION ALL SELECT 'TABLE T_COM_AUDIT_OM CASCADE CONSTRAINTS PURGE' FROM DUAL
        UNION ALL SELECT 'TABLE CM_COMM_AUDIT_ARPSE_PDP_MAP_HIST CASCADE CONSTRAINTS PURGE' FROM DUAL
        UNION ALL SELECT 'TABLE CM_COMM_AUDIT_ARPSE_PAC_HIST CASCADE CONSTRAINTS PURGE' FROM DUAL
        UNION ALL SELECT 'TABLE CM_COMM_AUDIT_ARPSE_DAC_HIST CASCADE CONSTRAINTS PURGE' FROM DUAL
        UNION ALL SELECT 'TABLE CM_COMM_AUDIT_ARPSE_HIST CASCADE CONSTRAINTS PURGE' FROM DUAL
        UNION ALL SELECT 'TABLE CM_COMM_AUDIT_PDP_OM_MAP_HIST CASCADE CONSTRAINTS PURGE' FROM DUAL
        UNION ALL SELECT 'TABLE CM_COMM_AUDIT_PDP_HIST CASCADE CONSTRAINTS PURGE' FROM DUAL
        UNION ALL SELECT 'TABLE CM_COMM_AUDIT_OM_HIST CASCADE CONSTRAINTS PURGE' FROM DUAL
        UNION ALL SELECT 'TABLE CM_COMM_AUDIT_ARPSE_PDP_MAP CASCADE CONSTRAINTS PURGE' FROM DUAL
        UNION ALL SELECT 'TABLE CM_COMM_AUDIT_ARPSE_PAC CASCADE CONSTRAINTS PURGE' FROM DUAL
        UNION ALL SELECT 'TABLE CM_COMM_AUDIT_ARPSE_DAC CASCADE CONSTRAINTS PURGE' FROM DUAL
        UNION ALL SELECT 'TABLE CM_COMM_AUDIT_ARPSE CASCADE CONSTRAINTS PURGE' FROM DUAL
        UNION ALL SELECT 'TABLE CM_COMM_AUDIT_PDP_OM_MAP CASCADE CONSTRAINTS PURGE' FROM DUAL
        UNION ALL SELECT 'TABLE CM_COMM_AUDIT_PDP CASCADE CONSTRAINTS PURGE' FROM DUAL
        UNION ALL SELECT 'TABLE CM_COMM_AUDIT_OM CASCADE CONSTRAINTS PURGE' FROM DUAL
        UNION ALL SELECT 'SEQUENCE SEQ_T_COM_AUDIT_ARPSE_PDP_MAP_HIST' FROM DUAL
        UNION ALL SELECT 'SEQUENCE SEQ_T_COM_AUDIT_ARPSE_PDP_MAP' FROM DUAL
        UNION ALL SELECT 'SEQUENCE SEQ_T_COM_AUDIT_ARPSE_PAC_HIST' FROM DUAL
        UNION ALL SELECT 'SEQUENCE SEQ_T_COM_AUDIT_ARPSE_PAC' FROM DUAL
        UNION ALL SELECT 'SEQUENCE SEQ_T_COM_AUDIT_ARPSE_DAC_HIST' FROM DUAL
        UNION ALL SELECT 'SEQUENCE SEQ_T_COM_AUDIT_ARPSE_DAC' FROM DUAL
        UNION ALL SELECT 'SEQUENCE SEQ_T_COM_AUDIT_ARPSE_HIST' FROM DUAL
        UNION ALL SELECT 'SEQUENCE SEQ_T_COM_AUDIT_ARPSE' FROM DUAL
        UNION ALL SELECT 'SEQUENCE SEQ_T_COM_AUDIT_PDP_OM_MAP_HIST' FROM DUAL
        UNION ALL SELECT 'SEQUENCE SEQ_T_COM_AUDIT_PDP_OM_MAP' FROM DUAL
        UNION ALL SELECT 'SEQUENCE SEQ_T_COM_AUDIT_PDP_HIST' FROM DUAL
        UNION ALL SELECT 'SEQUENCE SEQ_T_COM_AUDIT_PDP' FROM DUAL
        UNION ALL SELECT 'SEQUENCE SEQ_T_COM_AUDIT_OM_HIST' FROM DUAL
        UNION ALL SELECT 'SEQUENCE SEQ_T_COM_AUDIT_OM' FROM DUAL
        UNION ALL SELECT 'SEQUENCE SEQ_CM_COMM_AUDIT_ARPSE_PDP_MAP_HIST' FROM DUAL
        UNION ALL SELECT 'SEQUENCE SEQ_CM_COMM_AUDIT_ARPSE_PDP_MAP' FROM DUAL
        UNION ALL SELECT 'SEQUENCE SEQ_CM_COMM_AUDIT_ARPSE_PAC_HIST' FROM DUAL
        UNION ALL SELECT 'SEQUENCE SEQ_CM_COMM_AUDIT_ARPSE_PAC' FROM DUAL
        UNION ALL SELECT 'SEQUENCE SEQ_CM_COMM_AUDIT_ARPSE_DAC_HIST' FROM DUAL
        UNION ALL SELECT 'SEQUENCE SEQ_CM_COMM_AUDIT_ARPSE_DAC' FROM DUAL
        UNION ALL SELECT 'SEQUENCE SEQ_CM_COMM_AUDIT_ARPSE_HIST' FROM DUAL
        UNION ALL SELECT 'SEQUENCE SEQ_CM_COMM_AUDIT_ARPSE' FROM DUAL
        UNION ALL SELECT 'SEQUENCE SEQ_CM_COMM_AUDIT_PDP_OM_MAP_HIST' FROM DUAL
        UNION ALL SELECT 'SEQUENCE SEQ_CM_COMM_AUDIT_PDP_OM_MAP' FROM DUAL
        UNION ALL SELECT 'SEQUENCE SEQ_CM_COMM_AUDIT_PDP_HIST' FROM DUAL
        UNION ALL SELECT 'SEQUENCE SEQ_CM_COMM_AUDIT_PDP' FROM DUAL
        UNION ALL SELECT 'SEQUENCE SEQ_CM_COMM_AUDIT_OM_HIST' FROM DUAL
        UNION ALL SELECT 'SEQUENCE SEQ_CM_COMM_AUDIT_OM' FROM DUAL
    ) LOOP
        BEGIN
...
CREATE TABLE T_COM_AUDIT_OM (
    ...
    UPDATED_BY NUMBER,
    UPDATED_ON DATE,
    CONSTRAINT UK_T_COM_AUDIT_OM UNIQUE (AUDIT_YEAR_ID, OM_NO),
    CONSTRAINT CK_T_COM_AUDIT_OM_ACT CHECK (IS_ACTIVE IN ('Y', 'N'))
);

CREATE TABLE T_COM_AUDIT_OM_HIST (
    ...
    CONSTRAINT CK_T_COM_AUDIT_OM_H_ACT CHECK (IS_ACTIVE IN ('Y', 'N'))
);

CREATE TABLE T_COM_AUDIT_PDP (
    ...
    UPDATE_MANAGEMENT_RESPONSE CLOB,
    IS_ACTIVE CHAR(1) DEFAULT 'Y' NOT NULL,
    CREATED_BY NUMBER NOT NULL,
    CREATED_ON DATE DEFAULT SYSDATE NOT NULL,
    UPDATED_BY NUMBER,
    UPDATED_ON DATE,
    CONSTRAINT UK_T_COM_AUDIT_PDP UNIQUE (AUDIT_YEAR_ID, PDP_NO),
    CONSTRAINT CK_T_COM_AUDIT_PDP_ACT CHECK (IS_ACTIVE IN ('Y', 'N'))
);

CREATE TABLE T_COM_AUDIT_PDP_HIST (
    HIST_ID NUMBER PRIMARY KEY,
    ...
    SNAPSHOT_BY NUMBER NOT NULL,
    SNAPSHOT_ON DATE DEFAULT SYSDATE NOT NULL,
    CONSTRAINT CK_T_COM_AUDIT_PDP_H_ACT CHECK (IS_ACTIVE IN ('Y', 'N'))
);

CREATE TABLE T_COM_AUDIT_PDP_OM_MAP (
    ...
    UPDATED_BY NUMBER,
    UPDATED_ON DATE,
    CONSTRAINT UK_T_COM_AUDIT_PDP_OM UNIQUE (PDP_ID, OM_ID),
    CONSTRAINT FK_T_COM_AUDIT_MAP_PDP FOREIGN KEY (PDP_ID) REFERENCES T_COM_AUDIT_PDP (PDP_ID),
    CONSTRAINT FK_T_COM_AUDIT_MAP_OM FOREIGN KEY (OM_ID) REFERENCES T_COM_AUDIT_OM (OM_ID),
    CONSTRAINT CK_T_COM_AUDIT_MAP_ACT CHECK (IS_ACTIVE IN ('Y', 'N'))
);

CREATE TABLE T_COM_AUDIT_PDP_OM_MAP_HIST (
    HIST_ID NUMBER PRIMARY KEY,
...
CREATE TABLE T_COM_AUDIT_ARPSE (
    ...
    UPDATED_BY NUMBER,
    UPDATED_ON DATE,
    CONSTRAINT UK_T_COM_AUDIT_ARPSE UNIQUE (ARPSE_YEAR_ID, PARA_NO),
    CONSTRAINT CK_T_COM_AUDIT_ARPSE_ACT CHECK (IS_ACTIVE IN ('Y', 'N'))
);

CREATE TABLE T_COM_AUDIT_ARPSE_HIST (
    HIST_ID NUMBER PRIMARY KEY,
    ...
    SNAPSHOT_BY NUMBER NOT NULL,
    SNAPSHOT_ON DATE DEFAULT SYSDATE NOT NULL,
    CONSTRAINT CK_T_COM_AUDIT_ARPSE_H_ACT CHECK (IS_ACTIVE IN ('Y', 'N'))
);

CREATE TABLE T_COM_AUDIT_ARPSE_PDP_MAP (
    MAPPING_ID NUMBER PRIMARY KEY,
    ARPSE_ID NUMBER NOT NULL,
    PDP_ID NUMBER NOT NULL,
    IS_ACTIVE CHAR(1) DEFAULT 'Y' NOT NULL,
    ...
    UPDATED_BY NUMBER,
    UPDATED_ON DATE,
    CONSTRAINT UK_T_COM_AUDIT_ARPSE_PDP UNIQUE (ARPSE_ID, PDP_ID),
    CONSTRAINT FK_T_COM_AUDIT_ARPSE_PDP_A FOREIGN KEY (ARPSE_ID) REFERENCES T_COM_AUDIT_ARPSE (ARPSE_ID),
    CONSTRAINT FK_T_COM_AUDIT_ARPSE_PDP_P FOREIGN KEY (PDP_ID) REFERENCES T_COM_AUDIT_PDP (PDP_ID),
    CONSTRAINT CK_T_COM_AUDIT_ARPSE_PDP_ACT CHECK (IS_ACTIVE IN ('Y', 'N'))
);

CREATE TABLE T_COM_AUDIT_ARPSE_PDP_MAP_HIST (
    HIST_ID NUMBER PRIMARY KEY,
    MAPPING_ID NUMBER NOT NULL,
    ARPSE_ID NUMBER NOT NULL,
    PDP_ID NUMBER NOT NULL,
    ...
    SNAPSHOT_BY NUMBER NOT NULL,
    SNAPSHOT_ON DATE DEFAULT SYSDATE NOT NULL,
    CONSTRAINT CK_T_COM_AUDIT_ARPSE_PDP_H_ACT CHECK (IS_ACTIVE IN ('Y', 'N'))
);

CREATE TABLE T_COM_AUDIT_ARPSE_DAC (
    ...
    UPDATED_BY NUMBER,
    UPDATED_ON DATE,
    CONSTRAINT FK_T_COM_AUDIT_DAC_ARPSE FOREIGN KEY (ARPSE_ID) REFERENCES T_COM_AUDIT_ARPSE (ARPSE_ID),
    CONSTRAINT CK_T_COM_AUDIT_DAC_ACT CHECK (IS_ACTIVE IN ('Y', 'N'))
);

CREATE TABLE T_COM_AUDIT_ARPSE_DAC_HIST (
    HIST_ID NUMBER PRIMARY KEY,
    ...
    SNAPSHOT_BY NUMBER NOT NULL,
    SNAPSHOT_ON DATE DEFAULT SYSDATE NOT NULL,
    CONSTRAINT CK_T_COM_AUDIT_DAC_H_ACT CHECK (IS_ACTIVE IN ('Y', 'N'))
);

CREATE TABLE T_COM_AUDIT_ARPSE_PAC (
    ...
    UPDATED_BY NUMBER,
    UPDATED_ON DATE,
    CONSTRAINT FK_T_COM_AUDIT_PAC_ARPSE FOREIGN KEY (ARPSE_ID) REFERENCES T_COM_AUDIT_ARPSE (ARPSE_ID),
    CONSTRAINT CK_T_COM_AUDIT_PAC_ACT CHECK (IS_ACTIVE IN ('Y', 'N'))
);

CREATE TABLE T_COM_AUDIT_ARPSE_PAC_HIST (
    HIST_ID NUMBER PRIMARY KEY,
    ...
    SNAPSHOT_BY NUMBER NOT NULL,
    SNAPSHOT_ON DATE DEFAULT SYSDATE NOT NULL,
    CONSTRAINT CK_T_COM_AUDIT_PAC_H_ACT CHECK (IS_ACTIVE IN ('Y', 'N'))
);

CREATE SEQUENCE SEQ_T_COM_AUDIT_OM START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_T_COM_AUDIT_OM_HIST START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_T_COM_AUDIT_PDP START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_T_COM_AUDIT_PDP_HIST START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_T_COM_AUDIT_PDP_OM_MAP START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_T_COM_AUDIT_PDP_OM_MAP_HIST START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_T_COM_AUDIT_ARPSE START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_T_COM_AUDIT_ARPSE_HIST START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_T_COM_AUDIT_ARPSE_PDP_MAP START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_T_COM_AUDIT_ARPSE_PDP_MAP_HIST START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_T_COM_AUDIT_ARPSE_DAC START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_T_COM_AUDIT_ARPSE_DAC_HIST START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_T_COM_AUDIT_ARPSE_PAC START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_T_COM_AUDIT_ARPSE_PAC_HIST START WITH 1 INCREMENT BY 1 NOCACHE;

CREATE INDEX IDX_T_COM_AUDIT_MAP_PDP ON T_COM_AUDIT_PDP_OM_MAP (PDP_ID);
CREATE INDEX IDX_T_COM_AUDIT_MAP_OM ON T_COM_AUDIT_PDP_OM_MAP (OM_ID);
CREATE INDEX IDX_T_COM_AUDIT_ARPSE_PDP_A ON T_COM_AUDIT_ARPSE_PDP_MAP (ARPSE_ID);
CREATE INDEX IDX_T_COM_AUDIT_ARPSE_PDP_P ON T_COM_AUDIT_ARPSE_PDP_MAP (PDP_ID);
CREATE INDEX IDX_T_COM_AUDIT_DAC_ARPSE ON T_COM_AUDIT_ARPSE_DAC (ARPSE_ID);
CREATE INDEX IDX_T_COM_AUDIT_PAC_ARPSE ON T_COM_AUDIT_ARPSE_PAC (ARPSE_ID);
...
CREATE OR REPLACE PACKAGE BODY PKG_COMMERCIAL_AUDIT AS
    ...
    BEGIN
        OPEN IO_CURSOR FOR
            SELECT
                AUDIT_PERIOD_ID AS AUDITPERIODID,
                PERIOD_NAME AS PERIOD
            FROM TBL_AUDIT_PERIOD
            WHERE IS_ACTIVE = C_ACTIVE
            ORDER BY START_DATE DESC, AUDIT_PERIOD_ID DESC;
    END P_CAU_OM_YEAR;
    ...
    BEGIN
        ...
        IF NVL(P_DAC_ENTRY_ID, 0) = 0 THEN
            ...
            VALUES (
                V_DAC_ENTRY_ID, P_ARPSE_ID, P_DAC_RECOMMENDATION, P_DAC_DATE, P_UPDATED_STATUS,
                V_IS_ACTIVE, P_USER_PPNO, SYSDATE
            );
        ...
        ELSE
            ...
            SET ARPSE_ID = P_ARPSE_ID,
                ...
                DAC_DATE = P_DAC_DATE,
                UPDATED_STATUS = P_UPDATED_STATUS,
                IS_ACTIVE = V_IS_ACTIVE,
                UPDATED_BY = P_USER_PPNO,
                UPDATED_ON = SYSDATE
            WHERE DAC_ENTRY_ID = P_DAC_ENTRY_ID;
    ...
    BEGIN
        ...
        IF NVL(P_PAC_ENTRY_ID, 0) = 0 THEN
            ...
            VALUES (
                V_PAC_ENTRY_ID, P_ARPSE_ID, P_PAC_DIRECTIVE, P_PAC_DATE, P_UPDATED_STATUS,
                V_IS_ACTIVE, P_USER_PPNO, SYSDATE
            );
